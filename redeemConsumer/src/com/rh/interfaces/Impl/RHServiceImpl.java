	...
	public void setConvenienceCharge(UserRedeem userRedeem, DBPersister dbPersister) {
		...
		if(redeemAmountConfig!=null) {
			...
			for(String amt:amountArray) {
				//System.out.println("[amt]["+amt+"] [amountArray]["+amountArray[icount]+"] [(int)userRedeem.getAmount()]["+(int)userRedeem.getAmount()+"]");
				if(amt.equals((int)userRedeem.getAmount()+"")){
					//System.out.println("[amt]["+amt+"] [amountArray]["+amountArray[icount]+"] [(int)userRedeem.getAmount()]["+(int)userRedeem.getAmount()+"] inside the if");
