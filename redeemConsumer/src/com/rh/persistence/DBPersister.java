...
public class DBPersister {
	...
	public int getRedeemCount(long ettId) {
		String query="select count(1) from UserRedeem where ettId="+ettId+" and status='SUCCESS'";
	...
	public void firstRedeemOffer(UserAccountSummary userAccountSummary){
		...
		String query3 = "insert into UserEarningView (UASId,amount,createdTime,ettId,offerName) values(0,"+(int)userAccountSummary.getAmount()+",now(),"+userAccountSummary.getEttId()+",'"+userAccountSummary.getOfferName()+"')";
