...
<form action="<%=response.encodeURL(request.getContextPath())%>/UpdateOfferEvent" name="AddNewOfferForm" >
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>Update Offer Event</label><strong> &nbsp;</td>
</tr>
<%
String str1="";
String str2="";
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="appKey" type="text" id="appKey" value="<%=str2%>" class ="contentblack"/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="balanceCreditInDays" type="text" id="balanceCreditInDays" value="<%=str3%>" class ="contentblack"/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="currency" type="text" id="currency" value="<%=str5%>" class ="contentblack"/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="eventName" type="text" id="eventName" value="<%=str6%>" class ="contentblack"/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="eventValue" type="text" id="eventValue" value="<%=str7%>" class ="contentblack"/>
</td>
</tr>
<tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="incomeAmount" type="text" id="incomeAmount" value="<%=str8%>" class ="contentblack"/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="installedAmount" type="text" id="installedAmount" value="<%=str9%>" class ="contentblack"/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<textarea rows="2" cols="19" name="notification" id="notification" class ="contentblack" style="width: 170px; height: 50px;" maxlength="350" ><%=str10%></textarea>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="offerAmount" type="text" id="offerAmount" value="<%=str11%>" class ="contentblack"/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="offerCat" type="text" id="offerCat" value="<%=str12%>" class ="contentblack"/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="offerId" type="text" id="offerId" value="<%=str13%>" class ="contentblack"/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="pendingAmountCredit" type="text" id="pendingAmountCredit" value="<%=str14%>" class ="contentblack"/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="pendingRecCount" type="text" id="pendingRecCount" value="<%=str15%>" class ="contentblack"/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="pendingRecDay" type="text" id="pendingRecDay" value="<%=str16%>" class ="contentblack"/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="payOutHoldinMin"  type="number"  min="0" id="offerAmountShow" value="<%=str18%>" class ="contentblack"  /> Only Number
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<textarea rows="2" cols="19" name="payOutHoldNotification" id="payOutHoldNotification" class ="contentblack" style="width: 170px; height: 50px;" ><%=str19%></textarea>
