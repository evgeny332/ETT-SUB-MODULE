...
/*	if(imageUrl == "")
        {
         ...
         if(validity == "")
        {
                alert(" validity should not be blank.");
                return false;
        }
...
<form action="<%=response.encodeURL(request.getContextPath())%>/BreakingAlert" name="AddNewOfferForm" method="post">
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>Breaking Alert</label><strong> &nbsp;</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<textarea rows="2" cols="19" name="text" id="text" class ="contentblack" style="width: 170px; height: 50px;" >
</textarea>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="validity" type="validity" id="size" value="" class ="contentblack"/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="menuName" type="text" id="menuName" value="" class ="contentblack"/>
</td>
</tr>
<tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<textarea rows="2" cols="19" name="popUpHeading" id="popUpHeading" class ="contentblack" style="width: 170px; height: 50px;" ></textarea>
</td>
</tr>
<tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<textarea rows="2" cols="19" name="popUpText" id="popUpText" class ="contentblack" style="width: 170px; height: 50px;" ></textarea>
</td>
</tr>
<tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<textarea rows="2" cols="19" name="popUpButtonText" id="popUpButtonText" class ="contentblack" style="width: 170px; height: 50px;" ></textarea>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="popUpActionUrl" type="text" id="popUpActionUrl" value="" class ="contentblack"/>
</td>
</tr>
