...
<%@ page import="com.dndbean.SMS_CDRBean" %>
<%@ page import="java.util.*" %>
<%@taglib uri="/WEB-INF/displaytag-el.tld" prefix="display"%>
<jsp:useBean id="SMS_CDRBean" scope="application"
class="com.dndbean.SMS_CDRBean"/>
...
<script language="javascript" src ="JavaScript/cal_conf_smscdr.js"></script>
<script language="javascript" src ="JavaScript/validate2.js"></script>

<script language="javascript">
<!--
addCalendar("Date10", "cal1", "DateTime1", "SMS_CDRForm");
addCalendar("Date20", "cal2", "DateTime2", "SMS_CDRForm");
//-->
</script>
...
function Validate()
{
	var DateTime1 = document.SMS_CDRForm.DateTime1.value;
	...
	var DateTime2 = document.SMS_CDRForm.DateTime2.value;
	if(DateTime2 == "")
	{
		alert("To Date should not be blank.");
		return false;
	}
	var AParty = document.SMS_CDRForm.AParty.value;
	var BParty = document.SMS_CDRForm.BParty.value;
	if(AParty == "" || BParty == "" )
	{
...
{
	document.SMS_CDRForm.action="";
	window.location.href = "<%=response.encodeURL(request.getContextPath())%>/SMS_CDR";
}
</script>
<body background-color="#dddddd" >
<form action="<%=response.encodeURL(request.getContextPath())%>/SMS_CDR" name="SMS_CDRForm" >
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>SMS CDR</label><strong> &nbsp;</td>
</tr>
...
<tr>
<td width="33%" align="right" valign="top" scope="row"><label><b>Destination Number</label>&nbsp;</td>
<td width="2%" scope="row">&nbsp;</td>
<td width="58%" align="left" valign="top">
...
<display:column property="aparty" title="TM URN" media="csv excel html pdf " />
<display:column property="senderid" title="Sender ID" media="csv excel html pdf " />
<display:column property="circle" title="TM Circle" media="csv excel html pdf " />
<display:column property="bparty" title="Number" media="csv excel html pdf " />
<display:column property="timeval" title="Time" media="csv excel html pdf " />
<display:column property="errorcode" title="Error Code" media="csv excel html pdf " />
<display:column property="interfaceused" title="Interface Used" media="csv excel html pdf " />
<display:setProperty name="paging.banner.placement" value="top" />
<display:setProperty name="paging.banner.placement" value="bottom" />
<display:setProperty name="export.amount" value="list" />
<display:setProperty name="export.pdf" value="true" />
<display:setProperty name="export.pdf.filename" value="sms_cdr.pdf"/>
<display:setProperty name="export.excel.filename" value="sms_cdr.xls"/>
<display:setProperty name="export.csv.filename" value="sms_cdr.csv"/>
