...
<%@ page import="com.dndbean.SMS_ReportBean" %>
<%@ page import="java.util.*" %>
<%@taglib uri="/WEB-INF/displaytag-el.tld" prefix="display"%>
<jsp:useBean id="SMS_ReportBean" scope="application"
class="com.dndbean.SMS_ReportBean"/>
...
function cancelAction()
{
	...
	window.location.href = "<%=response.encodeURL(request.getContextPath())%>/SMS_Report";
}
</script>
<body background-color="#dddddd" >
<form action="<%=response.encodeURL(request.getContextPath())%>/SMS_Report" name="SMS_ReportForm" >
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>SMS Summary Report</label><strong> &nbsp;</td>
</tr>
...
<tr>
<td width="33%" scope="row" align="right" valign="top" ><label><b>Type</label>&nbsp;</td>
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<SELECT NAME="type" id ="type"  class ="contentblack" style="width: 105px;">
<OPTION  VALUE="All">All
<OPTION  VALUE="MSB">MSB
...
<display:setProperty name="export.pdf.filename" value="CallReport.pdf"/>
<display:setProperty name="export.excel.filename" value="CallReport.xls"/>
<display:setProperty name="export.csv.filename" value="CallReport.csv"/>
