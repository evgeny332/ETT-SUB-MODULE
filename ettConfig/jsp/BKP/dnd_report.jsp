...
<script language="javascript" src ="JavaScript/cal_conf.js"></script>
	<script>
function Validate()
{
	var DateTime1 = document.DndReportForm.DateTime1.value;
	var DateTime2 = document.DndReportForm.DateTime2.value;
...
{
	document.DndReportForm.action="";
	window.location.href = "<%=response.encodeURL(request.getContextPath())%>/DndReportServlet";
}
</script>
<body background-color="#dddddd" >
<form action="<%=response.encodeURL(request.getContextPath())%>/DndReportServlet" name="DndReportForm" >
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>Call Summary Report</label><strong> &nbsp;</td>
</tr>
