...
<%@ page import="com.dndbean.Conformance_ReportBean" %>
<%@ page import="java.util.*" %>
<%@taglib uri="/WEB-INF/displaytag-el.tld" prefix="display"%>
<jsp:useBean id="Conformance_ReportBean" scope="application"
class="com.dndbean.Conformance_ReportBean"/>
...
<script language="javascript" src ="JavaScript/cal_conf_cr.js"></script>
<script>
function Validate()
{
        var DateTime1 = document.Conformance_ReportForm.DateTime1.value;
        ...
        var DateTime2 = document.Conformance_ReportForm.DateTime2.value;
        if(DateTime2 == "")
        {
...
{
        document.Conformance_ReportForm.action="";
        window.location.href ="<%=response.encodeURL(request.getContextPath())%>/Conformance_Report";
}
</script>
<body background-color="#dddddd" >
<form action="<%=response.encodeURL(request.getContextPath())%>/Conformance_Report" name="Conformance_ReportForm" >
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>Conformance Report</label><strong> &nbsp;</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<SELECT NAME="circle" id ="circle"  class ="contentblack" style="width: 105px;">
<OPTION  VALUE="0">All
...
<display:column property="pconnected" title="% Allowed" media="csv excel html pdf " />
<display:column property="pdisconnected" title="% Blocked" media="csv excel html pdf " />
