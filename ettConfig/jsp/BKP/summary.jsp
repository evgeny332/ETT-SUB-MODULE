...
<%@ page import="com.dndbean.SummaryReportBean" %>
<%@ page import="java.util.*" %>
<%@taglib uri="/WEB-INF/displaytag-el.tld" prefix="display"%>
<jsp:useBean id="summaryBean" scope="application"
class="com.dndbean.SummaryReportBean"/>
...
<form action="<%=response.encodeURL(request.getContextPath())%>/SummaryReport" name="SummaryReportForm" >
...
<display:setProperty name="export.pdf.filename" value="RegistrationSummary.pdf"/>
<display:setProperty name="export.excel.filename" value="RegistrationSummary.xls"/>
<display:setProperty name="export.csv.filename" value="RegistrationSummary.csv"/>
