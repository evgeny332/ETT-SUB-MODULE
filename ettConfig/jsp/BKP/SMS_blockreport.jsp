...
<script language="javascript" src ="JavaScript/cal_conf_sb.js"></script>
<script language="javascript" src ="JavaScript/validate2.js"></script>

<script language="javascript">
<!--
addCalendar("Date10", "cal1", "DateTime1", "SMS_BlockReportForm");
addCalendar("Date20", "cal2", "DateTime2", "SMS_BlockReportForm");
//-->
</script>
...
function Validate()
{
	var DateTime1 = document.SMS_BlockReportForm.DateTime1.value;
	if(DateTime1 == "")
	{
...
{
	document.SMS_BlockReportForm.action="";
	window.location.href = "<%=response.encodeURL(request.getContextPath())%>/SMS_BlockReport";
}

</script>

<body background-color="#dddddd" >
<form action="<%=response.encodeURL(request.getContextPath())%>/SMS_BlockReport" name="SMS_BlockReportForm" >
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>Blocked SMS Report Download</label><strong> &nbsp;</td>
</tr>
