...
<%@ page import="com.dndbean.de_CircleWiseReportBean" %>
<%@ page import="java.util.*" %>
<%@taglib uri="/WEB-INF/displaytag-el.tld" prefix="display"%>
<jsp:useBean id="de_circleBean" scope="application"
class="com.dndbean.de_CircleWiseReportBean"/>
...
<script language="javascript" src ="JavaScript/cal_conf_c.js"></script>
<script>
function Validate()
{
        var DateTime1 = document.CircleWiseReportForm.DateTime1.value;
        ...
        var DateTime2 = document.CircleWiseReportForm.DateTime2.value;
        if(DateTime2 == "")
        {
...
{
        document.CircleWiseReportForm.action="";
        window.location.href = "<%=response.encodeURL(request.getContextPath())%>/de_CircleWiseReport";
}
</script>
<body background-color="#dddddd" >
<form action="<%=response.encodeURL(request.getContextPath())%>/de_CircleWiseReport" name="CircleWiseReportForm" >
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>File Wise De-Registration Report</label><strong> &nbsp;</td>
</tr>
...
<display:column property="sdatetime" title="Receive Date Time" media="csv excel html pdf " />
<%--<display:column property="circle" title="Circle" media="csv excel html pdf " />--%>
<display:column property="totalcount" title="Total" media="csv excel html pdf " />
<display:column property="successcount" title="Success" media="csv excel html pdf " />
<display:column property="failcount" title="Fail" media="csv excel html pdf " />
<display:column property="edatetime" title="Update Date Time" media="csv excel html pdf " />
<display:setProperty name="paging.banner.placement" value="top" />
<display:setProperty name="paging.banner.placement" value="bottom" />
<display:setProperty name="export.amount" value="list" />
<display:setProperty name="export.pdf" value="true" />
<display:setProperty name="export.pdf.filename" value="FileWiseDeregistrationReport.pdf"/>
<display:setProperty name="export.excel.filename" value="FileWiseDeregistrationReport.xls"/>
<display:setProperty name="export.csv.filename" value="FileWiseDeregistrationReport.csv"/>
