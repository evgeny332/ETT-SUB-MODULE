...
<%@ page import="com.dndbean.de_ErrorWiseReportBean" %>
<%@ page import="java.util.*" %>
<%@taglib uri="/WEB-INF/displaytag-el.tld" prefix="display"%>
<jsp:useBean id="de_errorBean" scope="application"
class="com.dndbean.de_ErrorWiseReportBean"/>
...
<script language="javascript" src ="JavaScript/cal_conf_e.js"></script>
<script>
function Validate()
{
        var DateTime1 = document.ErrorWiseReportForm.DateTime1.value;
        ...
        var DateTime2 = document.ErrorWiseReportForm.DateTime2.value;
        if(DateTime2 == "")
        {
...
{
        document.ErrorWiseReportForm.action="";
        location.reload(true);
}
</script>
<body background-color="#dddddd" >
<form action="<%=response.encodeURL(request.getContextPath())%>/de_ErrorWiseReport" name="ErrorWiseReportForm" >
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>Error Wise Detailed Report</label><strong> &nbsp;</td>
</tr>
...
<display:column property="file" title="File Name" media="csv excel html pdf " />
...
<display:column property="success" title="Success" media="csv excel html pdf " />
<display:column property="fail" title="Fail" media="csv excel html pdf " />
<display:setProperty name="paging.banner.placement" value="top" />
<display:setProperty name="paging.banner.placement" value="bottom" />
<display:setProperty name="export.amount" value="list" />
<display:setProperty name="export.pdf" value="true" />
<display:setProperty name="export.pdf.filename" value="ErrorWiseDeregistrationSummary.pdf"/>
<display:setProperty name="export.excel.filename" value="ErrorWiseDeregistrationSummary.xls"/>
<display:setProperty name="export.csv.filename" value="ErrorWiseDeregistrationSummary.csv"/>
