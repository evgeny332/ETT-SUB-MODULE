...
<%@ page import="com.dndbean.ErrorWiseReportBean" %>
<%@ page import="java.util.*" %>
<%@taglib uri="/WEB-INF/displaytag-el.tld" prefix="display"%>
<jsp:useBean id="ErrorBean" scope="application"
class="com.dndbean.ErrorWiseReportBean"/>
...
<form action="<%=response.encodeURL(request.getContextPath())%>/ErrorWiseReport" name="ErrorWiseReportForm" >
...
<display:setProperty name="export.pdf.filename" value="ErrorWiseRegistrationSummary.pdf"/>
<display:setProperty name="export.excel.filename" value="ErrorWiseRegistrationSummary.xls"/>
<display:setProperty name="export.csv.filename" value="ErrorWiseRegistrationSummary.csv"/>
