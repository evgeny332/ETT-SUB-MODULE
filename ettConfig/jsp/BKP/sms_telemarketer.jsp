...
<%@ page import="com.dndbean.SMS_TMReportBean" %>
<%@ page import="java.util.*" %>
<%@taglib uri="/WEB-INF/displaytag-el.tld" prefix="display"%>
<jsp:useBean id="sms_TMReportBean" scope="application" class="com.dndbean.SMS_TMReportBean"/>
...
<script language="javascript" src ="JavaScript/cal_sms_tm.js"></script>
	<script>
function Validate()
{
	var DateTime1 = document.SMS_TMReportForm.DateTime1.value;
	...
	var DateTime2 = document.SMS_TMReportForm.DateTime2.value;
	if(DateTime2 == "")
	{
...
{
	document.SMS_TMReportForm.action="";
	window.location.href = "<%=response.encodeURL(request.getContextPath())%>/SMS_TMReport";
}
</script>
...
{       type_id = document.getElementById('type').value;
	//alert("type_id"+type_id);
       ...
       if (type_id=="-1")
         { document.SMS_TMReportForm.reset();
        ...
        if ( xmlHttp != null ){
                ...
                try{
			xmlHttp.open("GET", "<%=urlToList%>?REQTYPE=GETURN&type_id=" + type_id , true);
...
function call_url1()
{       urn_id = document.getElementById('urn_name').value;
        createXmlHttpRequest();
        document.getElementById('loadingImg').style.display = '';
       if (urn_id=="-1")
         { document.SMS_TMReportForm.reset();
        ...
        if ( xmlHttp != null ){
                ...
                try{
                        xmlHttp.open("GET", "<%=urlToList%>?REQTYPE=GETNUMBER1&urn=" + urn_id , true);
                        xmlHttp.setRequestHeader("Content-Type","text/plain");
...
<form action="<%=response.encodeURL(request.getContextPath())%>/SMS_TMReport" name="SMS_TMReportForm" >
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<select id="type" name="type" value="" class ="contentblack" onChange='call_url();' style="width: 105px;">
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<select id="urn_name" name="urn_name" value="" class ="contentblack" onChange='call_url1();' style="width: 105px;">
	<option value="-1" selected>All</option>
</select>
</td>
...
<display:column property="type" title="Type" media="csv excel html pdf " />
<display:column property="circle" title="Circle" media="csv excel html pdf " />
<display:column property="total" title="Total SMS" media="csv excel html pdf " />
<display:column property="allowed" title="SMS Allowed" media="csv excel html pdf " />
<display:column property="blocked" title="SMS Blocked" media="csv excel html pdf " />
<display:column property="blockpf" title="P Blocked" media="csv excel html pdf " />
<display:column property="blockff" title="F Blocked" media="csv excel html pdf " />
<display:column property="pallowed" title="SMS Allowed %" media="csv excel html pdf " />
<display:column property="pblocked" title="SMS Blocked %" media="csv excel html pdf " />
<display:column property="pblockpf" title="P Blocked %" media="csv excel html pdf " />
<display:column property="pblockff" title="F Blocked %" media="csv excel html pdf " />
<display:setProperty name="paging.banner.placement" value="top" />
<display:setProperty name="paging.banner.placement" value="bottom" />
<display:setProperty name="export.amount" value="list" />
<display:setProperty name="export.pdf" value="true" />
<display:setProperty name="export.pdf.filename" value="SMS_TMReport.pdf"/>
<display:setProperty name="export.excel.filename" value="SMS_TMReport.xls"/>
<display:setProperty name="export.csv.filename" value="SMS_TMReport.csv"/>
