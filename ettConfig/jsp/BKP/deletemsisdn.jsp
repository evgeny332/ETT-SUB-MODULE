...
if ( showDataFlag.equals( "true" ) ){
        com.mcarbon.DeleteMsisdn dm = new com.mcarbon.DeleteMsisdn();
        request.setAttribute("bool", dm.CheckMsisdn(msisdn));
}
%>
...
function Validate()
{
	var msisdn = document.deletemsisdn.msisdn.value;
...
{
	document.deletemsisdn.showDataFlag.value = "true";
	document.deletemsisdn.submit();
}
function cancelAction()
{
	document.deletemsisdn.action="";
	window.location.href ="deletemsisdn.jsp";
}
</script>
<body background-color="#dddddd" >
<form action="deletemsisdn.jsp" name="deletemsisdn" method="POST" >
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>Delete MSISDN</label><strong> &nbsp;</td>
</tr>
...
<table>
<tr>
<td width="58%" align="center" valign="middle"><label class ="contentblack">MSISDN does not exist in database.</label>
</td>
<%
}
}
