...
<%@ page import="com.dndbean.CircleWiseReportBean" %>
<%@ page import="java.util.*" %>
<%@taglib uri="/WEB-INF/displaytag-el.tld" prefix="display"%>
<jsp:useBean id="circleBean" scope="application"
class="com.dndbean.CircleWiseReportBean"/>
...
function cancelAction()
{
        ...
        window.location.href ="<%=response.encodeURL(request.getContextPath())%>/CircleWiseReport";
}
</script>
<body background-color="#dddddd" >
<form action="<%=response.encodeURL(request.getContextPath())%>/CircleWiseReport" name="CircleWiseReportForm" >
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>File Wise Registration Report</label><strong> &nbsp;</td>
</tr>
...
<display:setProperty name="export.pdf.filename" value="FileWiseRegistrationReport.pdf"/>
<display:setProperty name="export.excel.filename" value="FileWiseRegistrationReport.xls"/>
<display:setProperty name="export.csv.filename" value="FileWiseRegistrationReport.csv"/>
