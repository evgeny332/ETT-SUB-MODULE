...
<%@ page import="com.dndbean.de_SummaryReportBean" %>
<%@ page import="java.util.*" %>
<%@taglib uri="/WEB-INF/displaytag-el.tld" prefix="display"%>
<jsp:useBean id="de_summaryBean" scope="application"
class="com.dndbean.de_SummaryReportBean"/>
...
<script language="javascript" src ="JavaScript/cal_conf_s.js"></script>
<script>
function Validate()
{
        var DateTime1 = document.SummaryReportForm.DateTime1.value;
        ...
        var DateTime2 = document.SummaryReportForm.DateTime2.value;
        if(DateTime2 == "")
        {
...
{
        document.SummaryReportForm.action="";
        location.reload(true);
}
</script>
<body background-color="#dddddd" >
<form action="<%=response.encodeURL(request.getContextPath())%>/de_SummaryReport" name="SummaryReportForm" >
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>Summary Report</label><strong> &nbsp;</td>
</tr>
...
<display:setProperty name="export.pdf.filename" value="DeregistrationSummary.pdf"/>
<display:setProperty name="export.excel.filename" value="DeregistrationSummary.xls"/>
<display:setProperty name="export.csv.filename" value="DeregistrationSummary.csv"/>
