...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>New Offer Promotion</label><strong> &nbsp;</td>
</tr>
...
<select name="offer_name" id="offer_name" class ="contentblack" style="height:25px; width:219px">
	...
	<option value="one">Verified User</option>
	<option value="zero">Not Verified User</option>
	<%
		String appKey="";
	...
	%>
	<option value="Airtel">Airtel Fail Redeem</option>
	<option value="Loop Mobile">Loop Mobile Fail Redeem</option>
	<option value="Tata Docomo">Tata Docomo Fail Redeem</option>
	<option value="Vodafone">Vodafone Fail Redeem</option>
	<option value="MTS">MTS Fail Redeem</option>
	<option value="Uninor">Uninor Fail Redeem</option>
	<option value="Aircel">Aircel Fail Redeem</option>
	<option value="Idea">Idea Fail Redeem</option>
	<option value="Reliance">Reliance Fail Redeem</option>
	<option value="BSNL">BSNL Fail Redeem</option>
</select> 
</td>
</tr>
