...
<%@ page import="com.earntt.RedeemAmountConfigBean" %>
<%@ page import="java.util.*" %>
<%@taglib uri="/WEB-INF/displaytag-el.tld" prefix="display"%>
<jsp:useBean id="RedeemAmountConfigBean" scope="application"
class="com.earntt.RedeemAmountConfigBean"/>
...
function Edit(id,operator,amount,status,type,fee,IstRedeemAmount,threshold,IstThreshold)
{
        window.location.href="<%=response.encodeURL(request.getContextPath())%>/EditRedeemAmountConfig?id="+id+"_"+operator+"_"+amount+"_"+status+"_"+type+"_"+fee+"_"+IstRedeemAmount+"_"+threshold+"_"+IstThreshold+"";
}
...
<form action="<%=response.encodeURL(request.getContextPath())%>/RedeemAmountConfig" name="SMS_ReportForm" >
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>Redeem Amount Config</label><strong> &nbsp;</td>
</tr>
...
<display:table name="requestScope.configDataList" pagesize="20" class="dataTable" style="width:99%" export="true" id="currentRowObject" >
...
<display:column property="amount" title="Amount" media="csv excel html " />
...
<display:column property="istRedeemAmount" title="IstRedeemAmount" media="csv excel html " />
<display:column property="threshold" title="Threshold" media="csv excel html " />
<display:column property="istThreshold" title="IstThreshold" media="csv excel html " />


<display:column title="Action">
<a href="#" onclick="Edit('${currentRowObject.id}', '${currentRowObject.operator}','${currentRowObject.amount}','${currentRowObject.status}','${currentRowObject.type}','${currentRowObject.fee}','${currentRowObject.istRedeemAmount}','${currentRowObject.threshold}','${currentRowObject.istThreshold}')" style="color:#4477AA">update</a>
</display:column>
<display:setProperty name="paging.banner.placement" value="top" />
<display:setProperty name="paging.banner.placement" value="bottom" />
<display:setProperty name="export.amount" value="list" />
<display:setProperty name="export.pdf" value="false" />
<display:setProperty name="export.excel.filename" value="RedeemAmountConfig.xls"/>
<display:setProperty name="export.csv.filename" value="RedeemAmountConfig.csv"/>
