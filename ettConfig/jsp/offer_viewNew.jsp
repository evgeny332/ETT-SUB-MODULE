...
function getOferId()
{
	var id=$("#offerId").val()
	//alert(id);
	window.location.href="<%=response.encodeURL(request.getContextPath())%>/EditOfferNew?offer_id="+id+"";
}
function deleet(id)
{
	//alert(id);
...
&nbsp;&nbsp;<a href="#" onclick="Edit('${currentRowObject.offerId}')" style="color:#4477AA">Edit</a>&nbsp;&nbsp;
</display:column>
...
<display:column property="offerCategory" title="Offer Category" media="csv excel html " />
<display:column property="pendingAmountCredit" title="Pending Amt Cr." media="csv excel html " />
<display:column property="callbackNotification" title="CallbackNotification" media="csv excel html " />
<display:column property="installedNotification" title="InstalledNotification" media="csv excel html " />
<display:column property="vendor" title="vendor Name" media="csv excel html " />
<display:column property="payOutOn" title="PayoutOn" media="csv excel html " />
<display:column property="payoutType" title="PayoutType" media="csv excel html " />
<display:column property="gender" title="Gender" media="csv excel html " />
<display:column property="operatorCircle" title="operatorCircle" media="csv excel html " />
<display:column property="ageLimit" title="ageLimit" media="csv excel html " />
<display:column property="rating" title="rating" media="csv excel html " />
