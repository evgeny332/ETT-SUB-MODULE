...
<form action="<%=response.encodeURL(request.getContextPath())%>/DeleteBreakingAlert" name="AddNewOfferForm" method="post">
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>Delete Breaking Alert</label><strong> &nbsp;</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<textarea rows="2" cols="19" name="text" id="text" class ="contentblack" style="width: 170px; height: 50px;" readonly><%=str3%>
</textarea>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="imageUrl" type="text" id="imageUrl" value="<%=str4%>" class ="contentblack" readonly/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="validity" type="validity" id="size" value="<%=str5%>" class ="contentblack" readonly/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<select  name="clickable" id="clickable" class ="contentblack" style="height:25px; width:175px" readonly>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<select name="onClickType" id="onClickType" class ="contentblack" style="height:25px; width:175px" readonly> 
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="offerId" type="text" id="offerId" value="<%=str8%>" class ="contentblack" readonly/>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="menuName" type="text" id="menuName" value="<%=str10%>" class ="contentblack" readonly/>
</td>
</tr>
<tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<textarea rows="2" cols="19" name="popUpHeading" id="popUpHeading" class ="contentblack" style="width: 170px; height: 50px;" readonly><%=str11%></textarea>
</td>
</tr>
<tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<textarea rows="2" cols="19" name="popUpText" id="popUpText" class ="contentblack" style="width: 170px; height: 50px;" readonly ><%=str12%></textarea>
</td>
</tr>
<tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<textarea rows="2" cols="19" name="popUpButtonText" id="popUpButtonText" class ="contentblack" style="width: 170px; height: 50px;" readonly><%=str13%></textarea>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="popUpActionUrl" type="text" id="popUpActionUrl" value="<%=str14%>" class ="contentblack" readonly/>
</td>
</tr>
