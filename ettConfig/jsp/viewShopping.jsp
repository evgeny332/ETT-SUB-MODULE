...
function getOferId()
{
	var id=$("#offerId").val()
	//alert(id);
	window.location.href="<%=response.encodeURL(request.getContextPath())%>/EditShopping?offer_id="+id+"";
}
function deleet(id)
{
	//alert(id);
...
<td width="76%" align="center" valign="bottom">
	...
	<tr>
		...
		<td width="76%" align="center" valign="bottom">
			...
			<tr>
				<td width="40%" align="center" valign="top" scope="row" ><strong><label>Shopping Offer Details</label><strong> &nbsp;</td>
			</tr>
...
<display:column property="amount" title="Offer Amount" media="csv excel html " />
...
<display:column property="buttonText" title="Button Text" media="csv excel html " />
<display:column property="title" title="Title" media="csv excel html " />
...
<display:setProperty name="export.excel.filename" value="ShoppingOfferReport.xls"/>
<display:setProperty name="export.csv.filename" value="ShoppingOfferReport.csv"/>
