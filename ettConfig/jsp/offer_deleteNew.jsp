...
<form action="<%=response.encodeURL(request.getContextPath())%>/DeleteOfferNew" name="AddNewOfferForm" >
...
<%--<tr>
<td width="33%" align="right" valign="top" scope="row"><label><b>Redirect Text</label>&nbsp;</td>
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">

<input name="redirectText" type="text" id="redirectText" value="<%=str25%>" class ="contentblack" readonly />
</td>
</tr>--%>
<tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="pendingAmountCredit" type="text" id="pendingAmountCredit" value="<%=str25%>" class ="contentblack" readonly />
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="pendingRecCount" type="text" id="pendingRecCount" value="<%=str26%>" class ="contentblack" readonly />
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="pendingRecDay" type="text" id="pendingRecDay" value="<%=str27%>" class ="contentblack" readonly />
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<%--<input name="callbackNotification" type="text" id="callbackNotification" value="" class ="contentblack"  />--%>
<textarea rows="2" cols="19" name="callbackNotification" id="callbackNotification" class ="contentblack" style="width: 170px; height: 50px;" ><%=str28%></textarea>
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="installedAmount" type="text" id="installedAmount" value="<%=str29%>" class ="contentblack" readonly />
</td>
</tr>
...
<td width="14%" align="left" valign="top">
<%--<input name="callbackNotification" type="text" id="callbackNotification" value="" class ="contentblack"  />--%>
<textarea rows="2" cols="19" name="installedNotification" id="installedNotification" class ="contentblack" style="width: 170px; height: 50px;" ><%=str30%></textarea>
</td>
</tr>
