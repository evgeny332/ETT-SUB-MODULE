...
function Validate()
{
	...
	if(offerAmount  == "")
	{
		alert("Range Limit Amount should not be blank.");
		 return false;
	}
}
function cancelAction()
{
	...
	//return false;
	window.location.href = "<%=response.encodeURL(request.getContextPath())%>/BrowsPlanLimit";
}
</script>
<body background-color="#dddddd" >
<form action="<%=response.encodeURL(request.getContextPath())%>/BrowsPlanLimitUpdate" name="AddNewOfferForm" >
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>Update Range Limit Amount</label><strong> &nbsp;</td>
</tr>
<%
String str1="";
String str2="";
...
<tr>
<td width="33%" align="right" valign="top" scope="row"><label><b>Range Limit Amount</label>&nbsp;</td>
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
...
<label>
<input type="submit" name="submit" id="submit" value="Submit" onclick="javascript: return Validate();"/></label>&nbsp;&nbsp;&nbsp;<label><input type="button" name="Cancel" value="Refresh" onclick="cancelAction();"></Button>
</label>
</td>
</tr>
