...
function cancelAction()
{
	...
	//return false;
	window.location.href = "<%=response.encodeURL(request.getContextPath())%>/RefundBulkAmt";
}
</script>
<body background-color="#dddddd" >
<form action="<%=response.encodeURL(request.getContextPath())%>/RefundBulkAmt" name="AddNewOfferForm" id="AddNewOfferForm" method="post">
...
<tr>
<td width="40%" align="center" valign="top" scope="row" ><strong><label>Refund Redeem Amount</label><strong> &nbsp;</td>
</tr>
...
<tr>
<td width="33%" align="right" valign="top" scope="row"><label><b>Redeem Amount</label>&nbsp;</td>
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
