...
<%@ page import="com.earntt.ShareOfferDetailsEntity" %>
<%@ page import="java.util.*" %>
<%@taglib uri="/WEB-INF/displaytag-el.tld" prefix="display"%>
<jsp:useBean id="ShareOfferDetailsEntity" scope="application" class="com.earntt.ShareOfferDetailsEntity"/>
...
function getOferId()
{
	var id=$("#offerId").val()
	//alert(id);
	window.location.href="<%=response.encodeURL(request.getContextPath())%>/EditShareOffer?offer_id="+id+"";
}
function deleet(id)
{
	//alert(id);
...
<td width="76%" align="center" valign="bottom">
	...
	<tr>
		...
		<td width="76%" align="center" valign="bottom">
			...
			<tr>
				<td width="40%" align="center" valign="top" scope="row" ><strong><label>Share Offer Details</label><strong> &nbsp;</td>
			</tr>
...
<display:column property="offerInfo" title="Offer Info" media="csv excel html" />
...
<display:column property="payouttype" title="Payout Type" media="csv excel html " />
<display:column property="osType" title="OS Type" media="csv excel html " />
...
<display:column property="shareText" title="Share Text" media="csv excel html " />
<display:column property="shareMessage" title="Share Message" media="csv excel html " />
<display:column property="shareText" title="Share URL" media="csv excel html " />
...
<display:setProperty name="export.excel.filename" value="ShareOfferReport.xls"/>
<display:setProperty name="export.csv.filename" value="ShareOfferReport.csv"/>
