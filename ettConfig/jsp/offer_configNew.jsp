...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="requisitePackages"  type="text" id="requisitePackages" value="" class ="contentblack"  />
</td>
</tr>
...
<td width="2%" scope="row">&nbsp;</td>
<td width="14%" align="left" valign="top">
<input name="deviceBasedOffer"  type="number"  min="0" id="deviceBasedOffer" value="0" class ="contentblack"  />0= Not Checked | 1=Checked
</td>
</tr>
