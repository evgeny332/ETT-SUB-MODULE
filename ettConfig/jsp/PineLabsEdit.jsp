...
<form action="<%=response.encodeURL(request.getContextPath())%>/UpdatePineLabs" name="AddNewOfferForm" method="post">
...
<label>
<input type="submit" name="submit" id="submit" value="Submit" /></label>&nbsp;&nbsp;&nbsp;<label><input type="button" name="Cancel" value="Cancel" onclick="cancelAction();"></Button>
</label>
</td>
</tr>
