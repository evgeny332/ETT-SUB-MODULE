...
*/
var titleColor="#FF7F27";
var daysColor="#FF7F27";
var bodyColor="#ffffff";
var dayColor="#ffffff";
var currentDayColor="#FFEEB1";
var footColor="#FF7F27";
var borderColor="#FFEEB1";

var titleFontColor = "#FFEEB1";
var daysFontColor = "#FFEEB1";
var dayFontColor = "#12538F";
var currentDayFontColor = "#12538F";
var footFontColor = "#FFEEB1";
...
function showCal(name) {
  ...
  if (currentCal != null) {
	...
	if ( layers[cal].style.pixelLeft > 750 ){
		//layers[cal].style.pixelLeft="800";
		layers[cal].style.zIndex="1";
	}else{
		layers[cal].style.pixelLeft=getLeftIE(layers[currentCal.id],true);
	}
      layers[cal].innerHTML=calendar;
      ...
      //layer.style.left="915px";
      layer.style.position="absolute";
      layer.style.zIndex="10000";
      //layer.style.left="800px";
...
function compareDates(date1, date2) {
  ...
  if (calRE.test(date2)) {
    ...
    d2 = getDateNumbers(getCurrentDate());
        ...
        var dStr1Temp = d1[0]+"^"+d1[1]+"*"+d1[2];
        d10=dStr1Temp.substring(0,dStr1Temp.indexOf("^"));
        d11=dStr1Temp.substring(dStr1Temp.indexOf("^")+1,dStr1Temp.indexOf("*"));
        d12=dStr1Temp.substring(dStr1Temp.indexOf("*")+1,dStr1Temp.length);
        ...
        var dStr1TempNew = d10 + "" + d11 + "" + d12;

        var dStr2Temp = d2[0]+"^"+d2[1]+"*"+d2[2];
        d20=dStr2Temp.substring(0,dStr2Temp.indexOf("^"));
        d21=dStr2Temp.substring(dStr2Temp.indexOf("^")+1,dStr2Temp.indexOf("*"));
        d22=dStr2Temp.substring(dStr2Temp.indexOf("*")+1,dStr2Temp.length);
        if ( d21.length < 2 )
        {
                d21="0"+d21;
        }
        ...
        var dStr2TempNew = d20 + "" + d21 + "" + d22;
  	var dStr1 = dStr1TempNew;
	var dStr2 = dStr2TempNew;
	alert(dStr2-dStr1);
...
function isValidTime(timeStr)
{
    ...
    if (hour < 0  || hour > 23)
    {
       alert("Hour must be between 0 and 22");
       return false;
    }
