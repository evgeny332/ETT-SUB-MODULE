...
public class EditBrackingAlert extends HttpServlet
{
	...
	public void doGet(HttpServletRequest request,HttpServletResponse response)throws ServletException, java.io.IOException
	{
		...
		try
		{
			...
			response.sendRedirect(response.encodeURL("jsp/BreakingEdit.jsp"));
		}
		catch(Exception Eb)
		{
			Eb.printStackTrace();
			System.out.println("["+GetDate()+"]"+"In EditBrackingAlert.java:    SQLState:  " + Eb.getMessage() );
	...
	public void GetResultData(ArrayList FileStatusList, String fid)
	{
		...
		{
			System.out.println("["+GetDate()+"]"+"In EditBrackingAlert.java:   Not able to connect with ORACLE");
			od.printStackTrace();
		}
		System.out.println("["+GetDate()+"]"+"In EditBrackingAlert.java:    ORA Connection Created!");
		try
		{
		...
		{
			System.out.println("["+GetDate()+"]"+"In EditBrackingAlert.java:    SQL Error" + ESQL.getMessage());
		}
		finally
		{
			try
			...
			{
				System.out.println("["+GetDate()+"]"+"In EditBrackingAlert.java:    Exception: " +ee.getMessage());
				ee.printStackTrace();
			}
		}
	}
