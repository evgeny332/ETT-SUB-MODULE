...
public class EditBrackingAlertDel extends HttpServlet
{
	...
	public void doGet(HttpServletRequest request,HttpServletResponse response)throws ServletException, java.io.IOException
	{
		...
		try
		{
			...
			response.sendRedirect(response.encodeURL("jsp/BreakingDel.jsp"));
		}
		catch(Exception Eb)
		{
			Eb.printStackTrace();
			System.out.println("["+GetDate()+"]"+"In EditBrackingAlertDel.java:    SQLState:  " + Eb.getMessage() );
	...
	public void GetResultData(ArrayList FileStatusList, String fid)
	{
		...
		SelectQuery="select id,status,text,imageUrl,validity,clickable,onClickType,offerId,actionUrl,menuName,popUpHeading,popUpText,popUpButtonText,popUpActionUrl from BreakingAlert where id='"+fid+"'";
		...
		{
			System.out.println("["+GetDate()+"]"+"In EditBrackingAlertDel.java:   Not able to connect with ORACLE");
			od.printStackTrace();
		}
		System.out.println("["+GetDate()+"]"+"In EditBrackingAlertDel.java:    ORA Connection Created!");
		try
		{
		...
		{
			System.out.println("["+GetDate()+"]"+"In EditBrackingAlertDel.java:    SQL Error" + ESQL.getMessage());
		}
		finally
		{
			try
			...
			{
				System.out.println("["+GetDate()+"]"+"In EditBrackingAlertDel.java:    Exception: " +ee.getMessage());
				ee.printStackTrace();
			}
		}
	}
