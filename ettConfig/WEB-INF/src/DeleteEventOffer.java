...
public class DeleteEventOffer extends HttpServlet
{
	...
	public void doGet(HttpServletRequest request,HttpServletResponse response)throws ServletException, java.io.IOException
	{
		...
		{
			Eb.printStackTrace();
			System.out.println("["+GetDate()+"]"+"In DeleteEventOffer.java:    SQLState:  " + Eb.getMessage() );
	...
	public int GetResultData(String offer_id)
	{
		...
		SelectQuery="delete from OfferEventDetails where id=?";
		...
		{
			System.out.println("["+GetDate()+"]"+"In DeleteEventOffer.java:   Not able to connect with ORACLE");
			od.printStackTrace();
		}
		System.out.println("["+GetDate()+"]"+"In DeleteEventOffer.java:    ORA Connection Created!");
		try
		{
		...
		{
			size = 0;	
			System.out.println("["+GetDate()+"]"+"In DeleteEventOffer.java:    SQL Error" + ESQL.getMessage());
			return size;
		}
		finally
		{
			...
			{
				System.out.println("["+GetDate()+"]"+"In DeleteEventOffer.java:    Exception: " +ee.getMessage());
				ee.printStackTrace();
			}
			return size;
		}
