...
public class AddNewOfferSeqNew extends HttpServlet
{
		...
		try
		{
			...
			if(size == 0 )
			{
				if(multipleEventOffer.equals("1"))
				{
					...
					response.sendRedirect(response.encodeURL("jsp/message.jsp?ST=E021&redirect=offer_configsequenceNew.jsp"));	
				}
			}
			else
				response.sendRedirect(response.encodeURL("jsp/offer_configsequenceNew.jsp"));
		}
		catch(Exception Eb)
		{
			Eb.printStackTrace();
			System.out.println("["+GetDate()+"]"+"In AddNewOfferSeqNew.java:    SQLState:  " + Eb.getMessage() );
			response.sendRedirect(response.encodeURL("jsp/redirectpage.jsp?ST=E016&redirect=offer_configsequenceNew.jsp"));
		}
	...
	public void GetOfferType(ArrayList OfferList)
	{
		String SelectQuery              = "";
                ...
                {
                        System.out.println("["+GetDate()+"]"+"In AddNewOfferSeqNew.java:   Not able to connect with ORACLE");
                        od.printStackTrace();
                }
                System.out.println("["+GetDate()+"]"+"In AddNewOfferSeqNew.java:    ORA Connection Created!");
                try
                {
                ...
                {
                        System.out.println("["+GetDate()+"]"+"In AddNewOfferSeqNew.java:    SQL Error" + ESQL.getMessage());
                }
                finally
                {
                        try
                        ...
                        {
                                System.out.println("["+GetDate()+"]"+"In AddNewOfferSeqNew.java:    Exception: " +ee.getMessage());
                                ee.printStackTrace();
                        }
                }
	...
	public int GetResultData(String offerId,String offerName,String actionUrl,String offerType,String description,String offerAmount,String appKey,String imageUrl,String priority,String Operators,String status,String size_data, String networkType, String alertText, String balanceType,String category,String balanceCreditInDays,String root,String pendingAmountCredit,String pendingRecCount,String pendingRecDay,String callbackNotification,String installedNotification,String venderName,String gender,String operatorCircle,String ageLimit,String playStoreDetails,String rating,String instructions,String appDescription,String payOutOn,String payoutType,String userDeferedInfo,String packageName,String offerPaymentType,String maxCreditLimit,String maxCreditPerDayLimit,String amountPerDataThreshold,String dataThreshold,String dataUsageEligibleDays,String timeIntervalOfRecheck,String isWifiDataAccepted,String dataOfferType,String version,String detailedInstructions,String winBackURL,String application_username,String reason,String Source,String deepLinkUrl,String isRepeatOffer,String city,String pincode,String state,String offerAmountShow,String multipleEventOffer,String payOutHoldinMin,String payOutHoldNotification)
	{
		String SelectQuery 		= "";
		...
		//System.out.println("["+GetDate()+"]"+" In AddNewOfferSeqNew.java:    ORA Connection Created! and Execute Query User ["+application_username+"] Query ["+SelectQuery+"]");
		try
		{
			...
			selectStmt.setString(57,offerId);
