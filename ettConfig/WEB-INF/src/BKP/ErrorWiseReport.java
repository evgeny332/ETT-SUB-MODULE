...
public class ErrorWiseReport extends HttpServlet
{
	...
	public void doGet(HttpServletRequest request,HttpServletResponse response)throws ServletException, java.io.IOException
	{
		...
		try
		{
			...
			response.sendRedirect(response.encodeURL("jsp/errorwisereport.jsp"));
			System.out.println("query has been executed...!!!");
		}
		catch(Exception Eb)
		{
			Eb.printStackTrace();
			System.out.println("["+GetDate()+"]"+"In ErrorWiseReport.java:    SQLState:  " + Eb.getMessage() );
	...
	public void GetResultData(String fromDateTime, String toDateTime,String circleselected,String HubID,ArrayList FileStatusList)
	{
		...
		System.out.println("["+GetDate()+"]"+"In ErrorWiseReport.java:    Query to be run is "+SelectQuery);
		try
		{
		...
		{
			System.out.println("["+GetDate()+"]"+"In ErrorWiseReport.java:   Not able to connect with ORACLE");
			od.printStackTrace();
		}
		System.out.println("["+GetDate()+"]"+"In ErrorWiseReport.java:    ORA Connection Created!");
		try
		{
			selectStmt = activeConnection.createStatement();
			DetailsResultSet = selectStmt.executeQuery(SelectQuery);
			ErrorWiseReportBean dbean = null;
			while(DetailsResultSet.next())
			{
				dbean = new ErrorWiseReportBean();
			...
			System.out.println("in ErrorWiseReport.java : "+FileStatusList.size());
			selectStmt.close();
			activeConnection.close();
		}
		catch(SQLException ESQL)
		{
			System.out.println("["+GetDate()+"]"+"In ErrorWiseReport.java:    SQL Error" + ESQL.getMessage());
		}
		finally
		{
			try
			...
			{
				System.out.println("["+GetDate()+"]"+"In ErrorWiseReport.java:    Exception: " +ee.getMessage());
				ee.printStackTrace();
			}
		}
	}
