...
public class BrowsPlanLimit extends HttpServlet
{
	...
	public void doGet(HttpServletRequest request,HttpServletResponse response)throws ServletException, java.io.IOException
	{
		...
		{
			Eb.printStackTrace();
			System.out.println("["+GetDate()+"]"+"In BrowsPlanLimit.java:    SQLState:  " + Eb.getMessage() );
	...
	public void GetResultData(ArrayList FileStatusList)
	{
		...
		SelectQuery="select * from BrowsPlanLimit";
		...
		{
			System.out.println("["+GetDate()+"]"+"In BrowsPlanLimit.java:   Not able to connect with ORACLE");
			od.printStackTrace();
		}
		System.out.println("["+GetDate()+"]"+"In BrowsPlanLimit.java:    ORA Connection Created!");
		try
		{
		...
		{
			System.out.println("["+GetDate()+"]"+"In BrowsPlanLimit.java:    SQL Error" + ESQL.getMessage());
		}
		finally
		{
			try
			...
			{
				System.out.println("["+GetDate()+"]"+"In BrowsPlanLimit.java:    Exception: " +ee.getMessage());
				ee.printStackTrace();
			}
		}
	}
