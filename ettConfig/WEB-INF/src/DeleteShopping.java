...
public class DeleteShopping extends HttpServlet
{
	...
	public void doGet(HttpServletRequest request,HttpServletResponse response)throws ServletException, java.io.IOException
	{
		...
		{
			Eb.printStackTrace();
			System.out.println("["+GetDate()+"]"+"In DeleteShopping.java:    SQLState:  " + Eb.getMessage() );
	...
	public int GetResultData(String offer_id)
	{
		...
		SelectQuery="delete from ett.ShoppingDetails where offerId=?";
		...
		{
			System.out.println("["+GetDate()+"]"+"In DeleteShopping.java:   Not able to connect with ORACLE");
			od.printStackTrace();
		}
		System.out.println("["+GetDate()+"]"+"In DeleteShopping.java:    ORA Connection Created!");
		try
		{
		...
		{
			size = 0;	
			System.out.println("["+GetDate()+"]"+"In DeleteShopping.java:    SQL Error" + ESQL.getMessage());
			return size;
		}
		finally
		{
			...
			{
				System.out.println("["+GetDate()+"]"+"In DeleteShopping.java:    Exception: " +ee.getMessage());
				ee.printStackTrace();
			}
			return size;
		}
